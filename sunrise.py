...
def calc(
    ...
    *,
    ...
    log.debug(f"Solar mean anomaly     M       = {M_degrees}")
    ...
    log.debug(f"Equation of the center C       = {(C_degrees)}")
    ...
    log.debug(f"Ecliptic longitude     L       = {(L_degrees)}")
...
def main():
    ...
    # latitude = 33.00801
    # longitude = 35.08794
    # 49.202347531821296, -122.91647403420454
    latitude = 49.202347531821296
    longitude = -122.91647403420454
    elevation = 0

    date_str = "2025-11-26"
    dt = datetime.strptime(date_str, "%Y-%m-%d")
    timestamp = dt.timestamp()
    print(calc(timestamp, latitude, longitude, elevation, debugtz=timezone(timedelta(hours=-8), "some")))
